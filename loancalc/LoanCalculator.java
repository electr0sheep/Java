...
public class LoanCalculator extends JFrame {
  ...
  private JButton jbtComputeLoan = new JButton("Compute Payment");
     ...
     *
     */
    public LoanCalculator() {   // My DERVIED CLASS CONSTRUCTOR
    ...
    // Register a listener to respond when the user interacts with the Compute Payment button.
    jbtComputeLoan.addActionListener(new ButtonListener());
    // NOTHING HERE IS BEING DISPLAYED YET!!!
  }
 
  /** IMPLEMENT THE LISTENER that Handles the Compute Payment button */
