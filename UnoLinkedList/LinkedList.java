...
public class LinkedList{
     ...
     */
    LinkedList(Card data, boolean sort){
        root = new Link(data, null);
        end = root;
        sorted = sort;
        size = 1;
     ...
     * @param data 
     */
    public void startList(Card data){
        root = new Link(data, null);
        end = root;
        size = 1;
    }
     ...
     */
    private void insertLink(Card data, Link location){
        if (location == null){
            location = new Link(data, null, null);
        } else{
    ...
    public Card getData(int num){
        return getLink(num).data;
    }
