...
class Setup extends JFrame{
    ...
    /**
     * Action Listener class that controls the buttons
     */
    ...
    /**
     * Get input value from window and verify it
     * @return Returns true if the information is acceptable
     */
    ...
    /**
     * Gets the number of decks from the window
    ...
    /**
     * Determines if the user wants the decks shuffled together or not
     * @return Boolean value that determines if the user wants the decks shuffled together or not
     */
    ...
    /**
     * 
     * @return An int value that indicates which action cards to omit
     */
    ...
    /**
     * 
     * @return A boolean value that indicates if the user wants to output to html
     */
...
/**
 * Window that is displayed after the input has been determined
 * @author Michael DeGraw
 */
class MainLoop extends JFrame{
    ...
    /**
     * Shows the current hand and totals etc.
     * @param thisHand Hand object
     */
...
/**
 * A window that asks if the user wants to use a GUI
 * @author Michael DeGraw
 */
class Query extends JDialog{
    ...
    /**
     * 
     * @return Boolean value that indicates if the user wants to use a GUI
     */
...
/**
 * Message Window class. This one is actually slightly clever.
 * @author Michael DeGraw
 */
class MessageBox extends JDialog{
    ...
    /**
     * Function used to set the size of the message window
     */
