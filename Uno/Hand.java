...
/**
 * Hand class that is a deck of at most 7 cards
 * @author Owner Michael DeGraw
 */
public class Hand{
    private Card[] hand;
    ...
    /**
     * Puts the hand into text
     * @return The text that describes the hand
     */
    String parseHand(){
        String result = "";
        for (int x = 0; x < 7; x++)
    ...
    /**
     * Gets the current exercise values
     * @return An int array describing how many exercises for this round
     */
    int[] getCurrent(){
        return current;
    }
    ...
    /**
     * Gets the total exercises so far
     * @return An int array that contains the total exercises thus far
     */
    int[] getTotals(){
        return totals;
    }
    ...
    /**
     * Get the number of exercises skipped so far
     * @return An int array that contains the total exercises skipped so far
     */
    int[] getSkips(){
        return skips;
    }
    ...
    //  draw until the deck is empty then do 
    /**
     * 
     * @param drawDeck The deck from which to draw cards
     * @param howMany How many cards to draw from the deck
     */
     ...
     * 
     * @param out Output Stream
     * @param returnDeck The deck to return cards to, in the case of skipped cards
     * @param html If the output stream is an html file
     */
